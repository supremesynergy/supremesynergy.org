...
(function (g) {
  ...
  function renderNatalClock(canvas, bp) {
    ...
    function go(mode) {
      ...
      if (cap) cap.textContent = mode === 'now' ? "Today's transits — where the planets sit right now, sweeping out from your birth sky." : 'Your birth sky — the heavens at the moment you were born.';
